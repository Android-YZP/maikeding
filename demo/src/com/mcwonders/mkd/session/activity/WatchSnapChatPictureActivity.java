package com.mcwonders.mkd.session.activity;
...
import com.mcwonders.uikit.common.util.media.ImageUtil;
import com.mcwonders.uikit.common.ui.imageview.BaseZoomableImageView;
...
public class WatchSnapChatPictureActivity extends UI {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mcwonders.mkd.R.layout.nim_watch_snapchat_activity);
    ...
    private void findViews() {
        ...
        loadingLayout = findViewById(com.mcwonders.mkd.R.id.loading_layout);
        image = (BaseZoomableImageView) findViewById(com.mcwonders.mkd.R.id.watch_image_view);
    }
    ...
    private void setImageView(final IMMessage msg) {
        ...
        bitmap = ImageUtil.rotateBitmapInNeeded(path, bitmap);
        if (bitmap == null) {
            Toast.makeText(this, com.mcwonders.mkd.R.string.picker_image_error, Toast.LENGTH_LONG).show();
    ...
    private int getImageResOnLoading() {
        return com.mcwonders.mkd.R.drawable.nim_image_default;
    }

    private int getImageResOnFailed() {
        return com.mcwonders.mkd.R.drawable.nim_image_download_failed;
    }
    ...
    private void onDownloadFailed() {
        loadingLayout.setVisibility(View.GONE);
        image.setImageBitmap(ImageUtil.getBitmapFromDrawableRes(getImageResOnFailed()));
        Toast.makeText(this, com.mcwonders.mkd.R.string.download_picture_fail, Toast.LENGTH_LONG).show();
    }
}
