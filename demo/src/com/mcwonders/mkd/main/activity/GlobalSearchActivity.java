...
public class GlobalSearchActivity extends UI implements OnItemClickListener {
    ...
    public boolean onCreateOptionsMenu(android.view.Menu menu) {
        getMenuInflater().inflate(com.mcwonders.mkd.R.menu.global_search_menu, menu);
        final MenuItem item = menu.findItem(com.mcwonders.mkd.R.id.action_search);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mcwonders.mkd.R.layout.global_search_result);

        ToolBarOptions options = new ToolBarOptions();
        setToolBar(com.mcwonders.mkd.R.id.toolbar, options);

        lvContacts = (ListView) findViewById(com.mcwonders.mkd.R.id.searchResultList);
        lvContacts.setVisibility(View.GONE);
...
//        adapter.addViewHolder(ItemTypes.TEAM, ContactHolder.class);
        ...
        findViewById(com.mcwonders.mkd.R.id.global_search_root).setOnTouchListener(new OnTouchListener() {
