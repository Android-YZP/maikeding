...
import com.mcwonders.mkd.main.helper.CustomNotificationCache;
import com.mcwonders.mkd.main.viewholder.CustomNotificationViewHolder;
...
public class CustomNotificationActivity extends UI implements TAdapterDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mcwonders.mkd.R.layout.system_notification_message_activity);

        ToolBarOptions options = new ToolBarOptions();
        options.titleId = com.mcwonders.mkd.R.string.custom_notification;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(com.mcwonders.mkd.R.menu.custom_notification_activity_menu, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case com.mcwonders.mkd.R.id.send_custom_notification_to_team:
                selectCustomNotificationTarget(true);
                break;
            case com.mcwonders.mkd.R.id.send_custom_notification_to_buddy:
    ...
    private void initListView() {
        listView = (MessageListView) findViewById(com.mcwonders.mkd.R.id.messageListView);
    ...
    private void selectCustomNotificationTarget(boolean team) {
        ...
        option.title = DemoCache.getContext().getString(com.mcwonders.mkd.R.string.select_custom_notification_target);
        option.multi = false;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CONTACT_SELECT_REQUEST_CODE && resultCode == Activity.RESULT_OK) {
            ...
            if (selected != null && !selected.isEmpty()) {
                ...
                requestDialog.setTitle(getString(com.mcwonders.mkd.R.string.send_custom_notification_tip));
    ...
    private void sendCustomNotification(String account, String content) {
        ...
        NIMClient.getService(MsgService.class).sendCustomNotification(notification).setCallback(new RequestCallback<Void>() {
            ...
            public void onSuccess(Void param) {
                Toast.makeText(CustomNotificationActivity.this, com.mcwonders.mkd.R.string.send_custom_notification_success, Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onFailed(int code) {
                Toast.makeText(CustomNotificationActivity.this, com.mcwonders.mkd.R.string.send_custom_notification_failed, Toast.LENGTH_SHORT).show();
            }
