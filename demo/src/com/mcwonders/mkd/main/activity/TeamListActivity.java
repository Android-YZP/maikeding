...
import com.mcwonders.uikit.contact.core.viewholder.ContactHolder;
...
public class TeamListActivity extends UI implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mcwonders.mkd.R.layout.group_list_activity);

        ToolBarOptions options = new ToolBarOptions();
        options.titleId = itemType == ItemTypes.TEAMS.ADVANCED_TEAM ? com.mcwonders.mkd.R.string.advanced_team : com.mcwonders.mkd.R.string.normal_team;
        setToolBar(com.mcwonders.mkd.R.id.toolbar, options);

        lvContacts = (ListView) findViewById(com.mcwonders.mkd.R.id.group_list);
        ...
        if (count == 0) {
            if (itemType == ItemTypes.TEAMS.ADVANCED_TEAM) {
                Toast.makeText(TeamListActivity.this, com.mcwonders.mkd.R.string.no_team, Toast.LENGTH_SHORT).show();
            } else if (itemType == ItemTypes.TEAMS.NORMAL_TEAM) {
                Toast.makeText(TeamListActivity.this, com.mcwonders.mkd.R.string.no_normal_team, Toast.LENGTH_SHORT).show();
            }
        }
