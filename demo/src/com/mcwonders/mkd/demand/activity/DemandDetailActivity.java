...
import com.mcwonders.mkd.demand.bean.Demand;
...
public class DemandDetailActivity extends UI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mcwonders.mkd.R.layout.demand_detail_activity);

        ToolBarOptions options = new ToolBarOptions();
        options.titleId = com.mcwonders.mkd.R.string.demand_detail;
        setToolBar(com.mcwonders.mkd.R.id.toolbar, options, com.mcwonders.mkd.R.id.toolbar_demand_detail_title);
        findViews();
        initDada();
    }
    ...
    private void findViews() {
        ...
        mLayoutSchedule = findView(com.mcwonders.mkd.R.id.layout_demand_detail_schedule);
        mLayoutPay = findView(com.mcwonders.mkd.R.id.layout_demand_detail_pay);
        mTvDemandName = findView(com.mcwonders.mkd.R.id.tv_demand_detail_name);
        mTvDemandPrice = findView(com.mcwonders.mkd.R.id.tv_demand_detail_price);
        mTvDemandId = findView(com.mcwonders.mkd.R.id.tv_demand_detail_number);
        mTvDemandSchedule = findView(com.mcwonders.mkd.R.id.tv_demand_detail_schedule);
        mIvPerson = findView(com.mcwonders.mkd.R.id.iv_demand_detail_certification);
        mIvMKJ = findView(com.mcwonders.mkd.R.id.iv_demand_detail_maikejia);
        mIvLYBZ = findView(com.mcwonders.mkd.R.id.iv_demand_detail_performance);
        mIvSDCY = findView(com.mcwonders.mkd.R.id.iv_demand_detail_field);
        mTvDemandDescribtion = findView(com.mcwonders.mkd.R.id.tv_demand_detail_describe);
        mLayoutSchedule.setOnClickListener(new DemandDetailOnClickListener());
        mLayoutPay.setOnClickListener(new DemandDetailOnClickListener());
    }
     ...
     * @author ZJ
     */
    private class DemandDetailOnClickListener implements View.OnClickListener {
        @Override
        public void onClick(View view) {
            Intent _intent = null;
            switch (view.getId()) {
                case com.mcwonders.mkd.R.id.layout_demand_detail_schedule:
                    _intent = new Intent(DemandDetailActivity.this, DemandScheduleActivity.class);
                    _intent.putExtra("demandId", demandId);
                    startActivity(_intent);
                    break;
                case com.mcwonders.mkd.R.id.layout_demand_detail_pay:
                    _intent = new Intent(DemandDetailActivity.this, DemandPayActivity.class);
                    _intent.putExtra("demandId", demandId);
                    startActivity(_intent);
                    break;
                default:
    ...
    private void updateDemandDetail() {
        ...
        if (isPerson == true) {
            mIvPerson.setImageResource(com.mcwonders.mkd.R.drawable.certification_nor);
        } else {
            mIvPerson.setImageResource(com.mcwonders.mkd.R.drawable.certification_grey);
        }
        if (isMKJ == true) {
            mIvMKJ.setImageResource(com.mcwonders.mkd.R.drawable.maikejia_attestation_nor);
        } else {
            mIvMKJ.setImageResource(com.mcwonders.mkd.R.drawable.maikejia_attestation_grey);
        }
        if (isLYBZ == true) {
            mIvLYBZ.setImageResource(com.mcwonders.mkd.R.drawable.performance_bond_nor);
        } else {
            mIvLYBZ.setImageResource(com.mcwonders.mkd.R.drawable.performance_bond_grey);
        }
        if (isSDCY == true) {
            mIvSDCY.setImageResource(com.mcwonders.mkd.R.drawable.field_testing_nor);
        } else {
            mIvSDCY.setImageResource(com.mcwonders.mkd.R.drawable.field_testing_grey);
        }
