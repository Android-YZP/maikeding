package com.mcwonders.uikit.session.module.input;
...
public class ActionsPanel {
    ...
    public static void init(View view, List<BaseAction> actions) {
        final ViewPager viewPager = (ViewPager) view.findViewById(com.mcwonders.uikit.R.id.viewPager);
        final ViewGroup indicator = (ViewGroup) view.findViewById(com.mcwonders.uikit.R.id.actions_page_indicator);
    ...
    private static void setIndicator(ViewGroup indicator, int total, int current) {
        if (total <= 1) {
            ...
            for (int i = 0; i < total; i++) {
                ...
                // 判断当前页码来更新
                if (i == current) {
                    imgCur.setBackgroundResource(com.mcwonders.uikit.R.drawable.nim_moon_page_selected);
                } else {
                    imgCur.setBackgroundResource(com.mcwonders.uikit.R.drawable.nim_moon_page_unselected);
                }
