package com.mcwonders.uikit.session.activity;
...
public class VoiceTrans {
    ...
    private void findViews() {
        textLayout = baseActivity.findViewById(com.mcwonders.uikit.R.id.voice_trans_layout);
        if (textLayout == null) {
            LayoutInflater layoutInflater = LayoutInflater.from(baseActivity);
            textLayout = layoutInflater.inflate(com.mcwonders.uikit.R.layout.nim_voice_trans_layout, null);
            ViewGroup.LayoutParams layoutParams = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
            baseActivity.addContentView(textLayout, layoutParams);
        }
        voiceTransText = (TextView) textLayout.findViewById(com.mcwonders.uikit.R.id.voice_trans_text);
        cancelBtn = textLayout.findViewById(com.mcwonders.uikit.R.id.cancel_btn);
        refreshingIndicator = (ProgressBar) textLayout.findViewById(com.mcwonders.uikit.R.id.refreshing_indicator);
        failIcon = textLayout.findViewById(com.mcwonders.uikit.R.id.trans_fail_icon);
    }
    ...
    public void voiceToText(IMMessage msg) {
        ...
        callFuture.setCallback(new RequestCallback<String>() {
            ...
            public void onFailed(int code) {
                ...
                voiceTransText.setText(com.mcwonders.uikit.R.string.trans_voice_failed);
