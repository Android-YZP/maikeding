...
public abstract class MsgViewHolderBase extends TViewHolder {
    ...
    protected int leftBackground() {
        return com.mcwonders.uikit.R.drawable.nim_message_item_left_selector;
    }

    // 当是发送出去的消息时，内容区域背景的drawable id
    protected int rightBackground() {
        return com.mcwonders.uikit.R.drawable.nim_message_item_right_selector;
    }
    ...
    protected final int getResId() {
        return com.mcwonders.uikit.R.layout.nim_message_item;
    }
    ...
    protected final void inflate() {
        ...
        progressBar = findViewById(com.mcwonders.uikit.R.id.message_item_progress);
        nameTextView = findViewById(com.mcwonders.uikit.R.id.message_item_nickname);
        contentContainer = findViewById(com.mcwonders.uikit.R.id.message_item_content);
        nameIconView = findViewById(com.mcwonders.uikit.R.id.message_item_name_icon);
        nameContainer = findViewById(com.mcwonders.uikit.R.id.message_item_name_layout);
        readReceiptTextView = findView(com.mcwonders.uikit.R.id.textViewAlreadyRead);
    ...
    private void setContent() {
        ...
        LinearLayout bodyContainer = (LinearLayout) view.findViewById(com.mcwonders.uikit.R.id.message_item_body);
