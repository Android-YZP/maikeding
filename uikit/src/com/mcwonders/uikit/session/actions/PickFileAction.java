package com.mcwonders.uikit.session.actions;
...
import com.mcwonders.uikit.session.helper.SendImageHelper;
import com.mcwonders.uikit.R;
import com.mcwonders.uikit.common.media.picker.activity.PickImageActivity;
import com.mcwonders.uikit.common.media.picker.activity.PreviewImageFromCameraActivity;
 ...
 */
public abstract class PickFileAction extends BaseAction {
    ...
    protected PickFileAction(int iconResId, int titleId, boolean multiSelect) {
    ...
    @Override
    public void onClick() {
        int requestCode = makeRequestCode(RequestCode.PICK_FILE);
