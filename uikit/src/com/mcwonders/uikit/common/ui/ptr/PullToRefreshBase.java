 ...
 *******************************************************************************/
package com.mcwonders.uikit.common.ui.ptr;
...
//		}
	...
	private void init(Context context, AttributeSet attrs) {
		...
		// Styleables from XML
		TypedArray a = context.obtainStyledAttributes(attrs, com.mcwonders.uikit.R.styleable.PullToRefresh);

		if (a.hasValue(com.mcwonders.uikit.R.styleable.PullToRefresh_ptrMode)) {
			mMode = Mode.mapIntToValue(a.getInteger(com.mcwonders.uikit.R.styleable.PullToRefresh_ptrMode, 0));
		}

		if (a.hasValue(com.mcwonders.uikit.R.styleable.PullToRefresh_ptrAnimationStyle)) {
			mLoadingAnimationStyle = AnimationStyle.mapIntToValue(a.getInteger(
					com.mcwonders.uikit.R.styleable.PullToRefresh_ptrAnimationStyle, 0));
		}
		 ...
		 * Styleables from XML
		 */
		if (a.hasValue(com.mcwonders.uikit.R.styleable.PullToRefresh_ptrRefreshableViewBackground)) {
			Drawable background = a.getDrawable(com.mcwonders.uikit.R.styleable.PullToRefresh_ptrRefreshableViewBackground);
			if (null != background) {
				mRefreshableView.setBackgroundDrawable(background);
			}
		} else if (a.hasValue(com.mcwonders.uikit.R.styleable.PullToRefresh_ptrAdapterViewBackground)) {
			Utils.warnDeprecation("ptrAdapterViewBackground", "ptrRefreshableViewBackground");
			Drawable background = a.getDrawable(com.mcwonders.uikit.R.styleable.PullToRefresh_ptrAdapterViewBackground);
			if (null != background) {
				mRefreshableView.setBackgroundDrawable(background);
			}
		}

		if (a.hasValue(com.mcwonders.uikit.R.styleable.PullToRefresh_ptrOverScroll)) {
			mOverScrollEnabled = a.getBoolean(com.mcwonders.uikit.R.styleable.PullToRefresh_ptrOverScroll, true);
		}

		if (a.hasValue(com.mcwonders.uikit.R.styleable.PullToRefresh_ptrScrollingWhileRefreshingEnabled)) {
			mScrollingWhileRefreshingEnabled = a.getBoolean(
					com.mcwonders.uikit.R.styleable.PullToRefresh_ptrScrollingWhileRefreshingEnabled, false);
		}
