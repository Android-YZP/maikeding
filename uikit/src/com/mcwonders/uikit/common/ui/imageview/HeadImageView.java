package com.mcwonders.uikit.common.ui.imageview;
...
public class HeadImageView extends CircleImageView {
    ...
    public static final int DEFAULT_AVATAR_THUMB_SIZE = (int) NimUIKit.getContext().getResources().getDimension(com.mcwonders.uikit.R.dimen.avatar_max_size);
    public static final int DEFAULT_AVATAR_NOTIFICATION_ICON_SIZE = (int) NimUIKit.getContext().getResources().getDimension(com.mcwonders.uikit.R.dimen.avatar_notification_size);
    ...
    public void loadTeamIconByTeam(final Team team) {
        // 先显示默认头像
        setImageResource(com.mcwonders.uikit.R.drawable.nim_avatar_group);
