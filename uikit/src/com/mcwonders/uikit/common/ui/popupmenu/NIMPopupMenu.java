    ...
    private void initListView() {
        if (rootView == null) {
            if (typeBg == TYPE_BG_BLACK) {
                rootView = LayoutInflater.from(context).inflate(com.mcwonders.uikit.R.layout.nim_popup_menu_black_layout, null);
            } else {
                rootView = LayoutInflater.from(context).inflate(com.mcwonders.uikit.R.layout.nim_popup_menu_layout, null);
            }
            ListView listView = (ListView) rootView.findViewById(com.mcwonders.uikit.R.id.popmenu_listview);
