package com.mcwonders.uikit.common.media.picker.adapter;
...
import com.mcwonders.uikit.common.media.picker.util.ThumbnailsUtil;
import com.mcwonders.uikit.common.util.sys.ScreenUtil;
import com.mcwonders.uikit.common.media.picker.model.PhotoInfo;
import com.mcwonders.uikit.common.media.picker.loader.RotateImageViewAware;
...
public class PickerPhotoAdapter extends BaseAdapter {
	...
	public void refreshView(int index) {
		...
		if (list.get(index).isChoose()) {
			holder.select.setImageResource(com.mcwonders.uikit.R.drawable.nim_picker_image_selected);
		} else {
			holder.select.setImageResource(com.mcwonders.uikit.R.drawable.nim_picker_image_normal);
		}
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {			
			...
			convertView = mInflater.inflate(com.mcwonders.uikit.R.layout.nim_picker_photo_grid_item, null);
			viewHolder.image = (ImageView) convertView.findViewById(com.mcwonders.uikit.R.id.picker_photo_grid_item_img);
			viewHolder.select = (ImageView) convertView.findViewById(com.mcwonders.uikit.R.id.picker_photo_grid_item_select);
			viewHolder.selectHotPot = (RelativeLayout) convertView.findViewById(com.mcwonders.uikit.R.id.picker_photo_grid_item_select_hotpot);
			...
			public void onClick(View v) {
				...
				if (photo.isChoose()) {
					...
					Toast.makeText(mContext, String.format(mContext.getResources().getString(
							com.mcwonders.uikit.R.string.picker_image_exceed_max_image_select), maxSelectSize), Toast.LENGTH_SHORT).show();
					return;
				}
		...
		if (list.get(position).isChoose()) {
			viewHolder.select.setImageResource(com.mcwonders.uikit.R.drawable.nim_picker_image_selected);
		} else {
			viewHolder.select.setImageResource(com.mcwonders.uikit.R.drawable.nim_picker_image_normal);
		}
		...
		if (photoInfo != null) {
			...
			PickerlImageLoadTool.disPlay(thumbPath, new RotateImageViewAware(viewHolder.image, photoInfo.getAbsolutePath()),
					com.mcwonders.uikit.R.drawable.nim_image_default);
		}
