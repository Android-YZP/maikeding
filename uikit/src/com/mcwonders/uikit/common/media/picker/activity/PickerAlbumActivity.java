package com.mcwonders.uikit.common.media.picker.activity;
...
import com.mcwonders.uikit.common.media.picker.fragment.PickerAlbumFragment;
import com.mcwonders.uikit.common.media.picker.loader.PickerConfig;
import com.mcwonders.uikit.common.media.picker.loader.PickerlImageLoadTool;
import com.mcwonders.uikit.common.media.picker.model.AlbumInfo;
import com.mcwonders.uikit.session.constant.RequestCode;
import com.mcwonders.uikit.common.media.picker.model.PhotoInfo;
import com.mcwonders.uikit.common.media.picker.model.PickerContract;
import com.mcwonders.uikit.model.ToolBarOptions;
import com.mcwonders.uikit.session.constant.Extras;
import com.mcwonders.uikit.common.media.picker.fragment.PickerImageFragment;
import com.mcwonders.uikit.common.media.picker.fragment.PickerImageFragment.OnPhotoSelectClickListener;
...
public class PickerAlbumActivity extends UI implements PickerAlbumFragment.OnAlbumItemClickListener,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.mcwonders.uikit.R.layout.nim_picker_album_activity);

		ToolBarOptions options = new ToolBarOptions();
		setToolBar(com.mcwonders.uikit.R.id.toolbar, options, com.mcwonders.uikit.R.id.toolbar_picker_album_title);
	...
	private void initActionBar(){
		setTitle(com.mcwonders.uikit.R.string.picker_image_folder);
	}

	private void initUI(){
		// bottom bar
		pickerBottomBar = (RelativeLayout) findViewById(com.mcwonders.uikit.R.id.picker_bottombar);
		if(isMutiMode){
			pickerBottomBar.setVisibility(View.VISIBLE);
		}else{
			pickerBottomBar.setVisibility(View.GONE);
		}
		pickerPreview = (TextView) findViewById(com.mcwonders.uikit.R.id.picker_bottombar_preview);
		pickerPreview.setOnClickListener(this);
		pickerSend = (TextView) findViewById(com.mcwonders.uikit.R.id.picker_bottombar_select);
		pickerSend.setOnClickListener(this);
		
		// fragment
		pickerAlbumLayout = (FrameLayout) findViewById(com.mcwonders.uikit.R.id.picker_album_fragment);
		pickerPhotosLayout = (FrameLayout) findViewById(com.mcwonders.uikit.R.id.picker_photos_fragment);
	...
	private void updateSelectBtnStatus(){
		...
		if(selectSize > 0){
			...
			pickerSend.setText(String.format(this.getResources().getString(
					com.mcwonders.uikit.R.string.picker_image_send_select), selectSize));
		}else{
			pickerPreview.setEnabled(false);
			pickerSend.setEnabled(false);
			pickerSend.setText(com.mcwonders.uikit.R.string.picker_image_send);
		}
	}
	
	@Override
	public void onClick(View v) {
		if (v.getId() == com.mcwonders.uikit.R.id.picker_bottombar_preview) {
            PickerAlbumPreviewActivity.start(this, hasSelectList, 0, isSupportOriginal,
                    isSendOriginalImage, hasSelectList, mutiSelectLimitSize);
        } else if (v.getId() == com.mcwonders.uikit.R.id.picker_bottombar_select) {
