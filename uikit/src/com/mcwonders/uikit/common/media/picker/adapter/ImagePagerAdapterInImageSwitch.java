...
import com.mcwonders.uikit.common.media.picker.activity.PreviewImageFromLocalActivity;
...
public class ImagePagerAdapterInImageSwitch extends PagerAdapter{
    ...
    public void destroyItem (ViewGroup container, int position, Object object) {
    	...
    	BaseZoomableImageView iv = (BaseZoomableImageView)layout.findViewById(com.mcwonders.uikit.R.id.imageView);
    	iv.clear();
...
//		if( Build.VERSION.SDK_INT >=  17 )
		...
		{
			layout = mInflater.inflate(com.mcwonders.uikit.R.layout.nim_preview_image_layout_multi_touch, null);
		}
		else 
		{
			layout = mInflater.inflate(com.mcwonders.uikit.R.layout.nim_preview_image_layout_zoom_control, null);
		}
