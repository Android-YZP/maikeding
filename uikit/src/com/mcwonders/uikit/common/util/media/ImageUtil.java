package com.mcwonders.uikit.common.util.media;
...
public class ImageUtil {
	...
	public static Bitmap getDefaultBitmapWhenGetFail() {
        try {
            return getBitmapImmutableCopy(NimUIKit.getContext().getResources(), com.mcwonders.uikit.R.drawable.nim_image_download_failed);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
