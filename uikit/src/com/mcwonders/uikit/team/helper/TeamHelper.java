package com.mcwonders.uikit.team.helper;

import com.mcwonders.uikit.NimUIKit;
import com.mcwonders.uikit.contact.core.item.ContactIdFilter;
...
public class TeamHelper {
    public static VerifyTypeEnum getVerifyTypeEnum(String name) {
        ...
        if (name.equals(NimUIKit.getContext().getString(com.mcwonders.uikit.R.string.team_allow_anyone_join))) {
            type = VerifyTypeEnum.Free;
        } else if (name.equals(NimUIKit.getContext().getString(com.mcwonders.uikit.R.string.team_need_authentication))) {
            type = VerifyTypeEnum.Apply;
        } else if (name.equals(NimUIKit.getContext().getString(com.mcwonders.uikit.R.string.team_not_allow_anyone_join))) {
    ...
    public static List<String> createAuthenMenuStrings() {
        int[] res = new int[]{com.mcwonders.uikit.R.string.team_allow_anyone_join, com.mcwonders.uikit.R.string.team_need_authentication,
                com.mcwonders.uikit.R.string.team_not_allow_anyone_join, com.mcwonders.uikit.R.string.cancel};
    ...
    public static int getVerifyString(VerifyTypeEnum type) {
        if (type == VerifyTypeEnum.Free) {
            return com.mcwonders.uikit.R.string.team_allow_anyone_join;
        } else if (type == VerifyTypeEnum.Apply) {
            return com.mcwonders.uikit.R.string.team_need_authentication;
        } else {
            return com.mcwonders.uikit.R.string.team_not_allow_anyone_join;
        }
    }

    // 邀请他人菜单项名称
    public static List<String> createInviteMenuStrings() {
        int[] res = new int[]{com.mcwonders.uikit.R.string.team_admin_invite, com.mcwonders.uikit.R.string.team_everyone_invite,
                com.mcwonders.uikit.R.string.cancel};
        List<String> btnNames = new ArrayList<>();
        for (int r : res) {
            btnNames.add(NimUIKit.getContext().getString(r));
        }
    ...
    public static TeamInviteModeEnum getInviteModeEnum(String name) {
        ...
        if (name.equals(NimUIKit.getContext().getString(com.mcwonders.uikit.R.string.team_admin_invite))) {
            type = TeamInviteModeEnum.Manager;
        } else if (name.equals(NimUIKit.getContext().getString(com.mcwonders.uikit.R.string.team_everyone_invite))) {
    ...
    public static int getInviteModeString(TeamInviteModeEnum type) {
        if (type == TeamInviteModeEnum.Manager) {
            return com.mcwonders.uikit.R.string.team_admin_invite;
        } else {
            return com.mcwonders.uikit.R.string.team_everyone_invite;
        }
    }

    // 群资料修改权限菜单名称
    public static List<String> createTeamInfoUpdateMenuStrings() {
        int[] res = new int[]{com.mcwonders.uikit.R.string.team_admin_update, com.mcwonders.uikit.R.string.team_everyone_update,
                com.mcwonders.uikit.R.string.cancel};
        List<String> btnNames = new ArrayList<>();
        for (int r : res) {
            btnNames.add(NimUIKit.getContext().getString(r));
    ...
    public static TeamUpdateModeEnum getUpdateModeEnum(String name) {
        ...
        if (name.equals(NimUIKit.getContext().getString(com.mcwonders.uikit.R.string.team_admin_update))) {
            type = TeamUpdateModeEnum.Manager;
        } else if (name.equals(NimUIKit.getContext().getString(com.mcwonders.uikit.R.string.team_everyone_update))) {
    ...
    public static int getInfoUpdateModeString(TeamUpdateModeEnum type) {
        if (type == TeamUpdateModeEnum.Manager) {
            return com.mcwonders.uikit.R.string.team_admin_update;
        } else {
            return com.mcwonders.uikit.R.string.team_everyone_update;
        }
    }

    // 被邀请人身份验证名称
    public static List<String> createTeamInviteeAuthenMenuStrings() {
        int[] res = new int[]{com.mcwonders.uikit.R.string.team_invitee_need_authen, com.mcwonders.uikit.R.string.team_invitee_not_need_authen,
                com.mcwonders.uikit.R.string.cancel};
        List<String> btnNames = new ArrayList<>();
        for (int r : res) {
            btnNames.add(NimUIKit.getContext().getString(r));
    ...
    public static TeamBeInviteModeEnum getBeInvitedModeEnum(String name) {
        ...
        if (name.equals(NimUIKit.getContext().getString(com.mcwonders.uikit.R.string.team_invitee_need_authen))) {
            type = TeamBeInviteModeEnum.NeedAuth;
        } else if (name.equals(NimUIKit.getContext().getString(com.mcwonders.uikit.R.string.team_invitee_not_need_authen))) {
    ...
    public static int getBeInvitedModeString(TeamBeInviteModeEnum type) {
        if (type == TeamBeInviteModeEnum.NeedAuth) {
            return com.mcwonders.uikit.R.string.team_invitee_need_authen;
        } else {
            return com.mcwonders.uikit.R.string.team_invitee_not_need_authen;
        }
    }
    ...
    public static ContactSelectActivity.Option getCreateContactSelectOption(ArrayList<String> memberAccounts, int teamCapacity) {
        ...
        option.maxSelectedTip = NimUIKit.getContext().getString(com.mcwonders.uikit.R.string.reach_team_member_capacity, teamCapacity);
    ...
    public static ContactSelectActivity.Option getContactSelectOption(List<String> memberAccounts) {
        ...
        option.title = NimUIKit.getContext().getString(com.mcwonders.uikit.R.string.invite_member);
