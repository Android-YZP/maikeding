...
import com.mcwonders.uikit.team.viewholder.TeamAnnounceHolder;
...
public class AdvancedTeamAnnounceActivity extends UI implements TAdapterDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mcwonders.uikit.R.layout.nim_advanced_team_announce);
    ...
    private void findViews() {
        announceListView = (ListView) findViewById(com.mcwonders.uikit.R.id.team_announce_listview);
        announceTips = (TextView) findViewById(com.mcwonders.uikit.R.id.team_announce_tips);
    }

    private void initActionbar() {
        TextView toolbarView = findView(com.mcwonders.uikit.R.id.action_bar_right_clickable_textview);
        toolbarView.setText(com.mcwonders.uikit.R.string.create);
    ...
    private void setAnnounceItem() {
        if (TextUtils.isEmpty(announce)) {
            announceTips.setText(com.mcwonders.uikit.R.string.without_content);
