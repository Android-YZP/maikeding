package com.mcwonders.uikit.team.activity;
...
import com.mcwonders.uikit.cache.SimpleCallback;
...
import com.mcwonders.uikit.team.helper.AnnouncementHelper;
...
public class AdvancedTeamCreateAnnounceActivity extends UI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mcwonders.uikit.R.layout.nim_advanced_team_create_announce);

        ToolBarOptions options = new ToolBarOptions();
        options.titleId = com.mcwonders.uikit.R.string.team_annourcement;
        setToolBar(com.mcwonders.uikit.R.id.toolbar, options);
    ...
    private void findViews() {
        teamAnnounceTitle = (EditText) findViewById(com.mcwonders.uikit.R.id.team_announce_title);
        teamAnnounceContent = (EditText) findViewById(com.mcwonders.uikit.R.id.team_announce_content);
    ...
    private void initActionbar() {
        toolbarView = findView(com.mcwonders.uikit.R.id.action_bar_right_clickable_textview);
        toolbarView.setText(com.mcwonders.uikit.R.string.save);
    ...
    private void requestAnnounceData() {
        if (!NetworkUtil.isNetAvailable(this)) {
            Toast.makeText(this, com.mcwonders.uikit.R.string.network_is_not_available, Toast.LENGTH_LONG).show();
            return;
        }

        if (TextUtils.isEmpty(teamAnnounceTitle.getText().toString())) {
            Toast.makeText(AdvancedTeamCreateAnnounceActivity.this, com.mcwonders.uikit.R.string.team_announce_notice, Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private void updateTeamData(Team team) {
        if (team == null) {
            Toast.makeText(this, getString(com.mcwonders.uikit.R.string.team_not_exist), Toast.LENGTH_SHORT).show();
            showKeyboard(false);
            finish();
        } else {
    ...
    private void updateAnnounce() {
        ...
        NIMClient.getService(TeamService.class).updateTeam(teamId, TeamFieldEnum.Announcement, announcement).setCallback(new RequestCallback<Void>() {
            ...
            public void onSuccess(Void param) {
                ...
                showKeyboard(false);
                finish();
                Toast.makeText(AdvancedTeamCreateAnnounceActivity.this, com.mcwonders.uikit.R.string.update_success, Toast.LENGTH_SHORT).show();
            }
            ...
            public void onFailed(int code) {
                DialogMaker.dismissProgressDialog();
                toolbarView.setEnabled(true);
                Toast.makeText(AdvancedTeamCreateAnnounceActivity.this, String.format(getString(com.mcwonders.uikit.R.string.update_failed), code), Toast.LENGTH_SHORT).show();
            }
