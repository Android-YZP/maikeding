package com.mcwonders.uikit.contact_selector.activity;
...
import com.mcwonders.uikit.common.ui.liv.LivIndex;
import com.mcwonders.uikit.contact.core.item.AbsContactItem;
import com.mcwonders.uikit.contact.core.item.ContactItemFilter;
import com.mcwonders.uikit.contact.core.model.IContact;
import com.mcwonders.uikit.contact.core.provider.ContactDataProvider;
import com.mcwonders.uikit.contact.core.provider.TeamMemberDataProvider;
import com.mcwonders.uikit.contact_selector.adapter.ContactSelectAdapter;
import com.mcwonders.uikit.contact_selector.viewholder.ContactsMultiSelectHolder;
import com.mcwonders.uikit.contact_selector.viewholder.ContactsSelectHolder;
import com.mcwonders.uikit.common.ui.liv.LetterIndexView;
import com.mcwonders.uikit.contact.core.viewholder.LabelHolder;
import com.mcwonders.uikit.contact_selector.adapter.ContactSelectAvatarAdapter;
import com.mcwonders.uikit.model.ToolBarOptions;
import com.mcwonders.uikit.contact.core.item.ContactItem;
import com.mcwonders.uikit.contact.core.item.ItemTypes;
import com.mcwonders.uikit.contact.core.model.ContactGroupStrategy;
...
public class ContactSelectActivity extends UI implements View.OnClickListener, android.support.v7.widget.SearchView.OnQueryTextListener {
    ...
    public boolean onCreateOptionsMenu(android.view.Menu menu) {
        // search view
        getMenuInflater().inflate(com.mcwonders.uikit.R.menu.contacts_search_menu, menu);
        MenuItem item = menu.findItem(com.mcwonders.uikit.R.id.action_contact_search);
        ...
        SearchView.SearchAutoComplete textView = (SearchView.SearchAutoComplete) searchView.findViewById(com.mcwonders.uikit.R.id.search_src_text);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mcwonders.uikit.R.layout.nim_contacts_select);

        ToolBarOptions options = new ToolBarOptions();
        setToolBar(com.mcwonders.uikit.R.id.toolbar, options, com.mcwonders.uikit.R.id.toolbar_contacts_select_title);
    ...
    private void initListView() {
        listView = findView(com.mcwonders.uikit.R.id.contact_list_view);
        ...
        // 字母导航
        TextView letterHit = (TextView) findViewById(com.mcwonders.uikit.R.id.tv_hit_letter);
        LetterIndexView idxView = (LetterIndexView) findViewById(com.mcwonders.uikit.R.id.liv_index);
        idxView.setLetters(getResources().getStringArray(com.mcwonders.uikit.R.array.letter_list2));
        ImageView imgBackLetter = (ImageView) findViewById(com.mcwonders.uikit.R.id.img_hit_letter);
    ...
    private void initContactSelectArea() {
        btnSelect = (Button) findViewById(com.mcwonders.uikit.R.id.btnSelect);
        ...
        bottomPanel = (RelativeLayout) findViewById(com.mcwonders.uikit.R.id.rlCtrl);
        scrollViewSelected = (HorizontalScrollView) findViewById(com.mcwonders.uikit.R.id.contact_select_area);
        if (option.multi) {
        ...
        imageSelectedGridView = (GridView) findViewById(com.mcwonders.uikit.R.id.contact_select_area_grid);
    ...
    private String getOKBtnText(int count) {
        String caption = getString(com.mcwonders.uikit.R.string.ok);
    ...
    public void onClick(View v) {
        if (v.getId() == com.mcwonders.uikit.R.id.btnSelect) {
