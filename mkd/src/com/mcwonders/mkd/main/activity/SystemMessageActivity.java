...
public class SystemMessageActivity extends UI implements TAdapterDelegate,
    ...
    private void deleteAllMessages() {
        ...
        items.clear();
        refresh();
        Toast.makeText(SystemMessageActivity.this, com.mcwonders.mkd.R.string.clear_all_success, Toast.LENGTH_SHORT).show();
    }

    private void showLongClickMenu(final SystemMessage message) {
        CustomAlertDialog alertDialog = new CustomAlertDialog(this);
        alertDialog.setTitle(com.mcwonders.mkd.R.string.delete_tip);
        String title = getString(com.mcwonders.mkd.R.string.delete_system_message);
    ...
    private void deleteSystemMessage(final SystemMessage message) {
        ...
        refresh();
        Toast.makeText(SystemMessageActivity.this, com.mcwonders.mkd.R.string.delete_success, Toast.LENGTH_SHORT).show();
    }
}
