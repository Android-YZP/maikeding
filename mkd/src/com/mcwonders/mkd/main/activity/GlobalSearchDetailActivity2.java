...
public class GlobalSearchDetailActivity2 extends UI implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mcwonders.mkd.R.layout.global_search_detail);
        ...
        TextView tipTextView = findView(com.mcwonders.mkd.R.id.search_result_tip);
        tipTextView.setText(tip);

        // listView adapter
        lvContacts = findView(com.mcwonders.mkd.R.id.search_result_list);
