 ...
 */
public class SettingsActivity extends AppCompatActivity implements SettingsAdapter.SwitchChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mcwonders.mkd.R.layout.settings_activity);

        ToolBarOptions options = new ToolBarOptions();
        options.titleId = com.mcwonders.mkd.R.string.settings;
//        setToolBar(R.id.toolbar, options);
    ...
    private void initUI() {
        initItems();
        listView = (ListView) findViewById(com.mcwonders.mkd.R.id.settings_listview);
        View footer = LayoutInflater.from(this).inflate(com.mcwonders.mkd.R.layout.settings_logout_footer, null);
        ...
        View logoutBtn = footer.findViewById(com.mcwonders.mkd.R.id.settings_button_logout);
    ...
    private void initItems() {
        ...
        items.add(new SettingTemplate(TAG_NOTICE_CONTENT, getString(com.mcwonders.mkd.R.string.notice_content), SettingType.TYPE_TOGGLE,
        ...
        items.add(new SettingTemplate(TAG_CUSTOM_NOTIFY, getString(com.mcwonders.mkd.R.string.custom_notification)));
        items.add(SettingTemplate.addLine());
        items.add(SettingTemplate.addLine());
    ...
    private void onListItemClick(SettingTemplate item) {
        ...
        switch (item.getId()) {
            ...
            case TAG_CLEAR:
                ...
                Toast.makeText(SettingsActivity.this, com.mcwonders.mkd.R.string.clear_msg_history_success, Toast.LENGTH_SHORT).show();
                break;
