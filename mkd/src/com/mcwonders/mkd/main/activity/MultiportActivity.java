...
public class MultiportActivity extends UI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mcwonders.mkd.R.layout.multiport_activity);

        ToolBarOptions options = new ToolBarOptions();
        options.titleId = com.mcwonders.mkd.R.string.multiport_manager;
        setToolBar(com.mcwonders.mkd.R.id.toolbar, options, com.mcwonders.mkd.R.id.toolbar_multiport_title);
    ...
    private void findViews() {
        versionLayout = findView(com.mcwonders.mkd.R.id.versions);
    }
        ...
        for (OnlineClient client : onlineClients) {
            ...
            switch (client.getClientType()) {
                case ClientType.Windows:
                    clientName.setText(com.mcwonders.mkd.R.string.computer_version);
                    break;
                case ClientType.Web:
                    clientName.setText(com.mcwonders.mkd.R.string.web_version);
                    break;
                case ClientType.Android:
                case ClientType.iOS:
                    clientName.setText(com.mcwonders.mkd.R.string.mobile_version);
                    break;
                default:
                    break;
            }
    ...
    private TextView initVersionView(OnlineClient client) {
        ...
        final View view = getLayoutInflater().inflate(com.mcwonders.mkd.R.layout.multiport_item, null);
        versionLayout.addView(view);
        TextView clientName = (TextView) view.findViewById(com.mcwonders.mkd.R.id.client_name);
        TextView clientLogout = (TextView) view.findViewById(com.mcwonders.mkd.R.id.client_logout);
