...
import com.mcwonders.mkd.common.util.sys.SysInfoUtil;
...
public class WelcomeActivity extends UI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mcwonders.mkd.R.layout.activity_welcome);
    ...
    private void showSplashView() {
        getWindow().setBackgroundDrawableResource(com.mcwonders.mkd.R.drawable.splash_bg);
        customSplash = true;
    }
