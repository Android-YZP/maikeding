...
import com.mcwonders.uikit.contact.ContactsFragment;
    ...
    public final static class FuncItem extends AbsContactItem {
        ...
        public static final class FuncViewHolder extends AbsContactViewHolder<FuncItem> {
            ...
            public View inflate(LayoutInflater inflater) {
                View view = inflater.inflate(com.mcwonders.mkd.R.layout.func_contacts_item, null);
                this.image = (ImageView) view.findViewById(com.mcwonders.mkd.R.id.img_head);
                this.funcName = (TextView) view.findViewById(com.mcwonders.mkd.R.id.tv_func_name);
                this.unreadNum = (TextView) view.findViewById(com.mcwonders.mkd.R.id.tab_new_msg_label);
                return view;
            }
            ...
            public void refresh(ContactDataAdapter contactAdapter, int position, FuncItem item) {
                if (item == VERIFY) {
                    ...
                    image.setImageResource(com.mcwonders.mkd.R.drawable.ic_my_computer);
                }
...
//            }
    ...
    private void addContactFragment() {
        ...
        fragment.setContainerId(com.mcwonders.mkd.R.id.contact_fragment);
