...
public class SettingsAdapter extends BaseAdapter {
    ...
    public SettingsAdapter(Context context, SwitchChangeListener switchChangeListener, List<SettingTemplate> items) {
        this(context, switchChangeListener, items, com.mcwonders.mkd.R.layout.setting_item_base);
    }
    ...
    public SettingsAdapter(Context context, SwitchChangeListener switchChangeListener, List<SettingTemplate> items, int layoutID) {
        ...
        itemHeight = context.getResources().getDimensionPixelSize(com.mcwonders.mkd.R.dimen.isetting_item_height);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(viewHolder == null) {
            ...
            viewHolder.indicator = (ImageView) convertView.findViewById(com.mcwonders.mkd.R.id.setting_item_indicator);
            viewHolder.headTitleView = (TextView) convertView.findViewById(com.mcwonders.mkd.R.id.head_title_label);
            viewHolder.headDetailView = (TextView) convertView.findViewById(com.mcwonders.mkd.R.id.head_detail_label);
        ...
        viewHolder.root.setBackgroundResource(com.mcwonders.mkd.R.drawable.nim_semitransparency_selector);
