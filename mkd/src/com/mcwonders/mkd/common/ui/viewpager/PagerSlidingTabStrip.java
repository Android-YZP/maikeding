...
package com.mcwonders.mkd.common.ui.viewpager;
...
import com.mcwonders.uikit.common.ui.drop.DropManager;
...
public class PagerSlidingTabStrip extends HorizontalScrollView implements OnPageChangeListener {
    ...
    private int underlineColor = getResources().getColor(com.mcwonders.mkd.R.color.skin_page_tab_underline_color);// 0xFFD9D9D9;

    private int dividerColor = 0x00000000;

    private int checkedTextColor = com.mcwonders.mkd.R.color.color_blue_0888ff;

    private int unCheckedTextColor = com.mcwonders.mkd.R.color.action_bar_tittle_color_555555;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        a = context.obtainStyledAttributes(attrs, com.mcwonders.mkd.R.styleable.PagerSlidingTabStrip);

        indicatorColor = a.getColor(com.mcwonders.mkd.R.styleable.PagerSlidingTabStrip_pstsIndicatorColor, indicatorColor);
        underlineColor = a.getColor(com.mcwonders.mkd.R.styleable.PagerSlidingTabStrip_pstsUnderlineColor, underlineColor);
        dividerColor = a.getColor(com.mcwonders.mkd.R.styleable.PagerSlidingTabStrip_pstsDividerColor, dividerColor);

        checkedTextColor = a.getResourceId(com.mcwonders.mkd.R.styleable.TwoTextView_ttLeftTextColor, com.mcwonders.mkd.R.color.color_blue_0888ff);
        unCheckedTextColor = a.getResourceId(com.mcwonders.mkd.R.styleable.TwoTextView_ttLeftTextColor,
                com.mcwonders.mkd.R.color.action_bar_tittle_color_555555);
        indicatorHeight = a
                .getDimensionPixelSize(com.mcwonders.mkd.R.styleable.PagerSlidingTabStrip_pstsIndicatorHeight, indicatorHeight);
        underlineHeight = a
                .getDimensionPixelSize(com.mcwonders.mkd.R.styleable.PagerSlidingTabStrip_pstsUnderlineHeight, underlineHeight);
        dividerPadding = a.getDimensionPixelSize(com.mcwonders.mkd.R.styleable.PagerSlidingTabStrip_pstsDividerPadding, dividerPadding);
        tabPadding = a.getDimensionPixelSize(com.mcwonders.mkd.R.styleable.PagerSlidingTabStrip_pstsTabPaddingLeftRight, tabPadding);
        scrollOffset = a.getDimensionPixelSize(com.mcwonders.mkd.R.styleable.PagerSlidingTabStrip_pstsScrollOffset, scrollOffset);
        textAllCaps = a.getBoolean(com.mcwonders.mkd.R.styleable.PagerSlidingTabStrip_pstsTextAllCaps, textAllCaps);
    ...
    private void setChooseTabViewTextColor(int position) {
        ...
        for (int i = 0; i < childCount; ++i) {
            ...
            imageView = (ImageView) tabView.findViewById(com.mcwonders.mkd.R.id.tab_title_image);
            textView = (TextView) tabView.findViewById(com.mcwonders.mkd.R.id.tab_title_label);
            if (i == position) {
                switch (i) {
                    case 0:
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        imageView.setImageResource(com.mcwonders.mkd.R.drawable.bottom_set_sel);
                        break;
                }
                ...
                switch (i) {
                    case 0:
                        imageView.setImageResource(com.mcwonders.mkd.R.drawable.bottom_home_nor);
                        break;
                    case 1:
                        imageView.setImageResource(com.mcwonders.mkd.R.drawable.bottom_message_nor);
                        break;
                    case 2:
                        imageView.setImageResource(com.mcwonders.mkd.R.drawable.bottom_set_nor);
                        break;
                }
    ...
    private void addTabView(final int position, String title) {
        ...
        if (tabView == null) {
            tabView = inflater.inflate(com.mcwonders.mkd.R.layout.tab_layout_main, null);
        }
        TextView titleTV = ((TextView) tabView.findViewById(com.mcwonders.mkd.R.id.tab_title_label));
        ...
        if (titleTV != null) {
            titleTV.setTextSize(TypedValue.COMPLEX_UNIT_PX, needAdaptation ?
                    resources.getDimensionPixelSize(com.mcwonders.mkd.R.dimen.text_size_10) : resources.getDimensionPixelSize(com.mcwonders.mkd.R.dimen.text_size_10));
            titleTV.setText(title);
        }

        final DropFake unreadTV = ((DropFake) tabView.findViewById(com.mcwonders.mkd.R.id.tab_new_msg_label));
        if (unreadTV != null) {
    ...
    public void updateTab(int index, ReminderItem item) {
        ...
        ImageView indicatorView = (ImageView) tabView.findViewById(com.mcwonders.mkd.R.id.tab_new_indicator);
        final DropFake unreadTV = ((DropFake) tabView.findViewById(com.mcwonders.mkd.R.id.tab_new_msg_label));
