package com.mcwonders.mkd.receiver;
...
public class JReceiver extends BroadcastReceiver {
	private static final String TAG = "YZP-JPush======>";
	...
	public void onReceive(Context context, Intent intent) {
        ...
        if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
			...
			try {
				...
				demandID = (int)jsonObject.get("DemandID");
				i.putExtra("DemandID", demandID);
			} catch (JSONException e) {
				e.printStackTrace();
			}
//			UIUtils.LogUtils(demandID+bundle.getString(JPushInterface.EXTRA_EXTRA)+"+++++++++++++++++++++++++++++");
