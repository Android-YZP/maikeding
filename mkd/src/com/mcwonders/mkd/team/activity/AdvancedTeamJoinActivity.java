...
public class AdvancedTeamJoinActivity extends UI implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mcwonders.mkd.R.layout.nim_advanced_team_join_activity);

        ToolBarOptions options = new ToolBarOptions();
        options.titleId = com.mcwonders.mkd.R.string.team_join;
    ...
    private void findViews() {
        teamNameText = (TextView) findViewById(com.mcwonders.mkd.R.id.team_name);
        memberCountText = (TextView) findViewById(com.mcwonders.mkd.R.id.member_count);
        applyJoinButton = (Button) findViewById(com.mcwonders.mkd.R.id.apply_join);
        teamTypeText = (TextView) findViewById(com.mcwonders.mkd.R.id.team_type);
    ...
    private void updateTeamInfo(final Team t) {
        if (t == null) {
            Toast.makeText(AdvancedTeamJoinActivity.this, com.mcwonders.mkd.R.string.team_not_exist, Toast.LENGTH_LONG).show();
            finish();
        } else {
            team = t;
            ...
            if (team.getType() == TeamTypeEnum.Advanced) {
                teamTypeText.setText(com.mcwonders.mkd.R.string.advanced_team);
            } else {
                teamTypeText.setText(com.mcwonders.mkd.R.string.normal_team);
            }
        }
    }
        ...
        if (team != null) {
            NIMClient.getService(TeamService.class).applyJoinTeam(team.getId(), null).setCallback(new RequestCallback<Team>() {
                ...
                public void onSuccess(Team team) {
                    ...
                    String toast = getString(com.mcwonders.mkd.R.string.team_join_success, team.getName());
                ...
                public void onFailed(int code) {
                    if (code == 808) {
                        applyJoinButton.setEnabled(false);
                        Toast.makeText(AdvancedTeamJoinActivity.this, com.mcwonders.mkd.R.string.team_apply_to_join_send_success,
                                Toast.LENGTH_SHORT).show();
                    } else if (code == 809) {
                        applyJoinButton.setEnabled(false);
                        Toast.makeText(AdvancedTeamJoinActivity.this, com.mcwonders.mkd.R.string.has_exist_in_team,
                                Toast.LENGTH_SHORT).show();
                    } else {
