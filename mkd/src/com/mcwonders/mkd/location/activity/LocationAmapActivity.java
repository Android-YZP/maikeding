...
import com.mcwonders.mkd.location.helper.NimGeocoder;
...
import com.mcwonders.uikit.LocationProvider;
...
//	private static final String TAG = "LocationAmapActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mcwonders.mkd.R.layout.map_view_amap_layout);
        mapView = (MapView) findViewById(com.mcwonders.mkd.R.id.autonavi_mapView);
    	mapView.onCreate(savedInstanceState);// 此方法必须重写

		ToolBarOptions options = new ToolBarOptions();
		setToolBar(com.mcwonders.mkd.R.id.toolbar, options, com.mcwonders.mkd.R.id.toolbar_map_view_amap_title);
    ...
    private void initView() {
		...
		sendButton.setText(com.mcwonders.mkd.R.string.send);
		sendButton.setOnClickListener(this);
    	sendButton.setVisibility(View.INVISIBLE);
    	
    	pinView = (ImageView) findViewById(com.mcwonders.mkd.R.id.location_pin);
    	pinInfoPanel = findViewById(com.mcwonders.mkd.R.id.location_info);
    	pinInfoTextView = (TextView) pinInfoPanel.findViewById(com.mcwonders.mkd.R.id.marker_address);

    	pinView.setOnClickListener(this);
    	pinInfoPanel.setOnClickListener(this);
    	
    	
    	btnMyLocation = (Button) findViewById(com.mcwonders.mkd.R.id.my_location);
    ...
    private void updateSendStatus() {
    	...
    	int titleResID = com.mcwonders.mkd.R.string.location_map;
    	if(TextUtils.isEmpty(addressInfo)) {
    		titleResID = com.mcwonders.mkd.R.string.location_loading;
    	...
    	if(btnMyLocation.getVisibility() == View.VISIBLE || Math.abs(-1 - cacheLatitude) < 0.1f) {
    		...
    		setTitle(com.mcwonders.mkd.R.string.my_location);
    	}
    }
    ...
    private void sendLocation() {
        ...
        addressInfo = TextUtils.isEmpty(addressInfo) ? getString(com.mcwonders.mkd.R.string.location_address_unkown) : addressInfo;
    ...
    public void onClick(View v) {
        ...
        case com.mcwonders.mkd.R.id.action_bar_right_clickable_textview:
            ...
            finish();
            break;
        case com.mcwonders.mkd.R.id.location_pin:
        	setPinInfoPanel(!isPinInfoPanelShow());
            break;
        case com.mcwonders.mkd.R.id.location_info:
        	pinInfoPanel.setVisibility(View.GONE);
            break;
        case com.mcwonders.mkd.R.id.my_location:
        ...
        public void onGeoCoderResult(NimLocation location) {
            if(latitude == location.getLatitude() && longitude == location.getLongitude()) { // 响应的是当前查询经纬度
                if(location.hasAddress()) {
                    ...
                    addressInfo = getString(com.mcwonders.mkd.R.string.location_address_unkown);
                }
                setPinInfoPanel(true);
                clearTimeoutHandler();
            }
	...
	private Runnable runable = new Runnable() {
		@Override
		public void run() {
			LocationAmapActivity.this.addressInfo = getString(com.mcwonders.mkd.R.string.location_address_unkown);
			setPinInfoPanel(true);
		}
	};
