...
import com.mcwonders.mkd.session.activity.WatchSnapChatPictureActivity;
...
public class MsgViewHolderSnapChat extends MsgViewHolderBase {
    ...
    protected int getContentResId() {
        return com.mcwonders.mkd.R.layout.nim_message_item_snapchat;
    }

    @Override
    protected void inflateContentView() {
        thumbnailImageView = (ImageView) view.findViewById(com.mcwonders.mkd.R.id.message_item_snap_chat_image);
        progressBar = findViewById(com.mcwonders.mkd.R.id.message_item_thumb_progress_bar); // 覆盖掉
        progressCover = findViewById(com.mcwonders.mkd.R.id.message_item_thumb_progress_cover);
        progressLabel = (TextView) view.findViewById(com.mcwonders.mkd.R.id.message_item_thumb_progress_text);
    }
    ...
    private void refreshStatus() {
        thumbnailImageView.setBackgroundResource(isReceivedMessage() ? com.mcwonders.mkd.R.drawable.message_view_holder_left_snapchat : com.mcwonders.mkd.R.drawable.message_view_holder_right_snapchat);
    ...
    private void layoutByDirection() {
        View body = findViewById(com.mcwonders.mkd.R.id.message_item_snap_chat_body);
        View tips = findViewById(com.mcwonders.mkd.R.id.message_item_snap_chat_tips_label);
