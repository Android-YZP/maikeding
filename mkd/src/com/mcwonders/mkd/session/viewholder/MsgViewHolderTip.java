...
public class MsgViewHolderTip extends MsgViewHolderBase {
    ...
    protected int getContentResId() {
        return com.mcwonders.uikit.R.layout.nim_message_item_notification;
    }

    @Override
    protected void inflateContentView() {
        notificationTextView = (TextView) view.findViewById(com.mcwonders.uikit.R.id.message_item_notification_label);
    }
