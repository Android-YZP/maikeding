package com.mcwonders.mkd.session;
...
import com.mcwonders.mkd.session.action.AVChatAction;
import com.mcwonders.mkd.session.action.GuessAction;
import com.mcwonders.mkd.session.action.SnapChatAction;
import com.mcwonders.mkd.session.action.TipAction;
import com.mcwonders.mkd.session.activity.MessageHistoryActivity;
...
import com.mcwonders.mkd.session.search.SearchMessageActivity;
import com.mcwonders.mkd.session.viewholder.MsgViewHolderAVChat;
import com.mcwonders.mkd.session.viewholder.MsgViewHolderDefCustom;
import com.mcwonders.mkd.session.viewholder.MsgViewHolderFile;
import com.mcwonders.mkd.session.viewholder.MsgViewHolderRTS;
import com.mcwonders.mkd.session.viewholder.MsgViewHolderTip;
import com.mcwonders.uikit.common.ui.popupmenu.PopupMenuItem;
import com.mcwonders.uikit.session.actions.BaseAction;
import com.mcwonders.uikit.session.module.MsgForwardFilter;
import com.mcwonders.uikit.session.module.MsgRevokeFilter;
import com.mcwonders.uikit.team.model.TeamRequestCode;
import com.mcwonders.mkd.DemoCache;
import com.mcwonders.mkd.session.action.FileAction;
import com.mcwonders.mkd.session.action.RTSAction;
import com.mcwonders.mkd.session.extension.CustomAttachParser;
import com.mcwonders.mkd.session.extension.CustomAttachment;
import com.mcwonders.mkd.session.viewholder.MsgViewHolderGuess;
import com.mcwonders.mkd.session.viewholder.MsgViewHolderSnapChat;
import com.mcwonders.mkd.session.viewholder.MsgViewHolderSticker;
import com.mcwonders.uikit.NimUIKit;
import com.mcwonders.uikit.common.ui.dialog.EasyAlertDialogHelper;
import com.mcwonders.uikit.common.ui.popupmenu.NIMPopupMenu;
import com.mcwonders.uikit.session.SessionCustomization;
import com.mcwonders.uikit.session.SessionEventListener;
import com.mcwonders.uikit.session.helper.MessageListPanelHelper;
import com.mcwonders.uikit.team.model.TeamExtras;
...
//            p2pCustomization.backgroundUri = "android.resource://com.mcwonders.mkd/drawable/bk"
...
//            actions.add(new TipAction());
            ...
            cloudMsgButton.iconId = com.mcwonders.mkd.R.drawable.nav_chatting_records_icon;
...
//            buttons.add(infoButton);
    ...
    private static List<PopupMenuItem> getMoreMenuItems(Context context, String sessionId, SessionTypeEnum sessionTypeEnum) {
        ...
        moreMenuItems.add(new PopupMenuItem(context, ACTION_HISTORY_QUERY, sessionId,
                sessionTypeEnum, DemoCache.getContext().getString(com.mcwonders.mkd.R.string.message_history_query)));
        moreMenuItems.add(new PopupMenuItem(context, ACTION_SEARCH_MESSAGE, sessionId,
                sessionTypeEnum, DemoCache.getContext().getString(com.mcwonders.mkd.R.string.message_search_title)));
        moreMenuItems.add(new PopupMenuItem(context, ACTION_CLEAR_MESSAGE, sessionId,
                sessionTypeEnum, DemoCache.getContext().getString(com.mcwonders.mkd.R.string.message_clear)));
