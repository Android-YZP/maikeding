...
import com.mcwonders.mkd.common.util.crash.AppCrashHandler;
import com.mcwonders.mkd.common.util.sys.SystemUtil;
import com.mcwonders.mkd.config.ExtraOptions;
...
import com.mcwonders.uikit.contact.ContactProvider;
import com.mcwonders.uikit.contact.core.query.PinYin;
...
public class NimApplication extends Application {
    ...
    private void updateLocale() {
        ...
        strings.status_bar_multi_messages_incoming = getString(com.mcwonders.mkd.R.string.nim_status_bar_multi_messages_incoming);
        strings.status_bar_image_message = getString(com.mcwonders.mkd.R.string.nim_status_bar_image_message);
        strings.status_bar_audio_message = getString(com.mcwonders.mkd.R.string.nim_status_bar_audio_message);
        strings.status_bar_custom_message = getString(com.mcwonders.mkd.R.string.nim_status_bar_custom_message);
        strings.status_bar_file_message = getString(com.mcwonders.mkd.R.string.nim_status_bar_file_message);
        strings.status_bar_location_message = getString(com.mcwonders.mkd.R.string.nim_status_bar_location_message);
        strings.status_bar_notification_message = getString(com.mcwonders.mkd.R.string.nim_status_bar_notification_message);
        strings.status_bar_ticker_text = getString(com.mcwonders.mkd.R.string.nim_status_bar_ticker_text);
        strings.status_bar_unsupported_message = getString(com.mcwonders.mkd.R.string.nim_status_bar_unsupported_message);
        strings.status_bar_video_message = getString(com.mcwonders.mkd.R.string.nim_status_bar_video_message);
        strings.status_bar_hidden_message_content = getString(com.mcwonders.mkd.R.string.nim_status_bar_hidden_msg_content);
    ...
    private UserInfoProvider infoProvider = new UserInfoProvider() {
        ...
        public int getDefaultIconResId() {
            return com.mcwonders.mkd.R.drawable.avatar_def;
        }
        ...
        public Bitmap getTeamIcon(String teamId) {
            ...
            // 默认图
            Drawable drawable = getResources().getDrawable(com.mcwonders.mkd.R.drawable.nim_avatar_group);
