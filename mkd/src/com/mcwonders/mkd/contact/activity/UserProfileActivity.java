...
public class UserProfileActivity extends UI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mcwonders.mkd.R.layout.user_profile_activity);

        ToolBarOptions options = new ToolBarOptions();
        options.titleId = com.mcwonders.mkd.R.string.user_profile;
        setToolBar(com.mcwonders.mkd.R.id.toolbar, options, com.mcwonders.mkd.R.id.toolbar_user_profile_title);
    ...
    private void findViews() {
        ...
        addFriendBtn = findView(com.mcwonders.mkd.R.id.add_buddy);
        chatBtn = findView(com.mcwonders.mkd.R.id.begin_chat);
        removeFriendBtn = findView(com.mcwonders.mkd.R.id.remove_buddy);
        birthdayLayout = findView(com.mcwonders.mkd.R.id.birthday);
        nickText = findView(com.mcwonders.mkd.R.id.user_nick);
        birthdayText = (TextView) birthdayLayout.findViewById(com.mcwonders.mkd.R.id.value);
        phoneLayout = findView(com.mcwonders.mkd.R.id.phone);
        mobileText = (TextView) findViewById(com.mcwonders.mkd.R.id.phone_value);
        emailLayout = findView(com.mcwonders.mkd.R.id.email);
        emailText = (TextView) emailLayout.findViewById(com.mcwonders.mkd.R.id.value);
        signatureLayout = findView(com.mcwonders.mkd.R.id.signature);
        signatureText = (TextView) signatureLayout.findViewById(com.mcwonders.mkd.R.id.value);
        aliasLayout = findView(com.mcwonders.mkd.R.id.alias);
        ((TextView) birthdayLayout.findViewById(com.mcwonders.mkd.R.id.attribute)).setText(com.mcwonders.mkd.R.string.birthday);
        ((TextView) findViewById(com.mcwonders.mkd.R.id.phone_attribute)).setText(com.mcwonders.mkd.R.string.phone);
    ...
    private void initActionbar() {
        ...
        toolbarView.setText(com.mcwonders.mkd.R.string.edit);
    ...
    private void updateUserInfoView() {
        ...
        if (userInfo.getGenderEnum() == GenderEnum.MALE) {
            ...
            genderImage.setBackgroundResource(com.mcwonders.mkd.R.drawable.nim_male);
        } else if (userInfo.getGenderEnum() == GenderEnum.FEMALE) {
            genderImage.setVisibility(View.VISIBLE);
            genderImage.setBackgroundResource(com.mcwonders.mkd.R.drawable.nim_female);
        } else {
    ...
    private SwitchButton addToggleItemView(String key, int titleResId, boolean initState) {
        ViewGroup vp = (ViewGroup) getLayoutInflater().inflate(com.mcwonders.mkd.R.layout.nim_user_profile_toggle_item, null);
        ViewGroup.LayoutParams vlp = new ViewGroup.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT, (int) getResources().getDimension(com.mcwonders.mkd.R.dimen.isetting_item_height));
        vp.setLayoutParams(vlp);

        TextView titleText = ((TextView) vp.findViewById(com.mcwonders.mkd.R.id.user_profile_title));
        titleText.setText(titleResId);

        SwitchButton switchButton = (SwitchButton) vp.findViewById(com.mcwonders.mkd.R.id.user_profile_toggle);
    ...
    private void updateAlias(boolean isFriend) {
        if (isFriend) {
            ...
            aliasLayout.findViewById(com.mcwonders.mkd.R.id.arrow_right).setVisibility(View.VISIBLE);
            ...
            aliasLayout.findViewById(com.mcwonders.mkd.R.id.arrow_right).setVisibility(View.GONE);
            nickText.setVisibility(View.GONE);
            nameText.setText(NimUserInfoCache.getInstance().getUserName(account));
        }
    }
    ...
    private SwitchButton.OnChangedListener onChangedListener = new SwitchButton.OnChangedListener() {
        ...
        public void OnChanged(View v, final boolean checkState) {
            ...
            if (!NetworkUtil.isNetAvailable(UserProfileActivity.this)) {
                Toast.makeText(UserProfileActivity.this, com.mcwonders.mkd.R.string.network_is_not_available, Toast.LENGTH_SHORT).show();
    ...
    private void onAddFriendByVerify() {
        ...
        requestDialog.setTitle(getString(com.mcwonders.mkd.R.string.add_friend_verify_tip));
        requestDialog.addNegativeButtonListener(com.mcwonders.mkd.R.string.cancel, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                requestDialog.dismiss();
            }
        });
        requestDialog.addPositiveButtonListener(com.mcwonders.mkd.R.string.send, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                requestDialog.dismiss();
        ...
        NIMClient.getService(FriendService.class).addFriend(new AddFriendData(account, verifyType, msg))
                .setCallback(new RequestCallback<Void>() {
                    ...
                    public void onFailed(int code) {
                        DialogMaker.dismissProgressDialog();
                        if (code == 408) {
                            Toast.makeText(UserProfileActivity.this, com.mcwonders.mkd.R.string.network_is_not_available, Toast
                                    .LENGTH_SHORT).show();
                        } else {
    ...
    private void onRemoveFriend() {
        ...
        EasyAlertDialog dialog = EasyAlertDialogHelper.createOkCancelDiolag(this, getString(com.mcwonders.mkd.R.string.remove_friend),
                getString(com.mcwonders.mkd.R.string.remove_friend_tip), true,
                new EasyAlertDialogHelper.OnDialogActionListener() {
                    ...
                    public void doOkAction() {
                        ...
                        NIMClient.getService(FriendService.class).deleteFriend(account).setCallback(new RequestCallback<Void>() {
                            ...
                            public void onSuccess(Void param) {
                                DialogMaker.dismissProgressDialog();
                                Toast.makeText(UserProfileActivity.this, com.mcwonders.mkd.R.string.remove_friend_success, Toast.LENGTH_SHORT).show();
                                finish();
                            }
